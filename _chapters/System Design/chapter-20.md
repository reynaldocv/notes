---
layout: home
chapter: "Metrics Monitoring and Alerting System"
...
<div style="margin-left:3rem">
    <img src="{{site.baseurl}}/assets/images/System Design/20. Metrics Monitoring/images/metrics-monitoring-core-components.png" alt="metrics-monitoring-core-components" width="500" />
</div>
...
<div style="margin-left:3rem">
    <img src="{{site.baseurl}}/assets/images/System Design/20. Metrics Monitoring/images/metrics-example-1.png" alt="metrics-example-1" width="500" />
</div>

The data can be identified by the following table:

<div style="margin-left:3rem">
    <img src="{{site.baseurl}}/assets/images/System Design/20. Metrics Monitoring/images/metrics-example-1-data.png" alt="metrics-example-1-data" width="500" />
</div>
...
<div style="margin-left:3rem">
    <img src="{{site.baseurl}}/assets/images/System Design/20. Metrics Monitoring/images/time-series-data-example.png" alt="time-series-data-example" width="500" />
</div>

A good way to visualize how data looks like:

<div style="margin-left:3rem">
    <img src="{{site.baseurl}}/assets/images/System Design/20. Metrics Monitoring/images/time-series-data-viz.png" alt="time-series-data-viz" width="500" />
</div>
...
<div style="margin-left:3rem">
    <img src="{{site.baseurl}}/assets/images/System Design/20. Metrics Monitoring/images/influxdb-scale.png" alt="influxdb-scale" width="500" />
</div>
...
<div style="margin-left:3rem">
    <img src="{{site.baseurl}}/assets/images/System Design/20. Metrics Monitoring/images/high-level-design.png" alt="high-level-design" width="500" />
</div>
...
<div style="margin-left:3rem">
    <img src="{{site.baseurl}}/assets/images/System Design/20. Metrics Monitoring/images/metrics-collection.png" alt="metrics-collection" width="500" />
</div>
...
<div style="margin-left:3rem">
    <img src="{{site.baseurl}}/assets/images/System Design/20. Metrics Monitoring/images/pull-model-example.png" alt="pull-model-example" width="500" />
</div>
...
<div style="margin-left:3rem">
    <img src="{{site.baseurl}}/assets/images/System Design/20. Metrics Monitoring/images/service-discovery-example.png" alt="service-discovery-example" width="500" />
</div>

Here's a detailed explanation of the metrics collection flow:

<div style="margin-left:3rem">
    <img src="{{site.baseurl}}/assets/images/System Design/20. Metrics Monitoring/images/metrics-collection-flow.png" alt="metrics-collection-flow" width="500" />
</div>
...
<div style="margin-left:3rem">
    <img src="{{site.baseurl}}/assets/images/System Design/20. Metrics Monitoring/images/consistent-hash-ring.png" alt="consistent-hash-ring" width="500" />
</div>

With the push model, on the other hand, services push their metrics to the metrics collector proactively:

<div style="margin-left:3rem">
    <img src="{{site.baseurl}}/assets/images/System Design/20. Metrics Monitoring/images/push-model-example.png" alt="push-model-example" width="500" />
</div>
...
<div style="margin-left:3rem">
    <img src="{{site.baseurl}}/assets/images/System Design/20. Metrics Monitoring/images/metrics-collector-agent.png" alt="metrics-collector-agent" width="500" />
</div>
...
<div style="margin-left:3rem">
    <img src="{{site.baseurl}}/assets/images/System Design/20. Metrics Monitoring/images/metrics-transmission-pipeline.png" alt="metrics-transmission-pipeline" width="500" />
</div>
...
<div style="margin-left:3rem">
    <img src="{{site.baseurl}}/assets/images/System Design/20. Metrics Monitoring/images/queuing-mechanism.png" alt="queuing-mechanism" width="500" />
</div>
...
<div style="margin-left:3rem">
    <img src="{{site.baseurl}}/assets/images/System Design/20. Metrics Monitoring/images/metrics-collection-kafka.png" alt="metrics-collection-kafka" width="500" />
</div>
...
<div style="margin-left:3rem">
    <img src="{{site.baseurl}}/assets/images/System Design/20. Metrics Monitoring/images/cache-layer-query-service.png" alt="cache-layer-query-service" width="500" />
</div>
...
<div style="margin-left:3rem">
    <img src="{{site.baseurl}}/assets/images/System Design/20. Metrics Monitoring/images/double-delta-encoding.png" alt="double-delta-encoding" width="500" />
</div>
...
<div style="margin-left:3rem">
    <img src="{{site.baseurl}}/assets/images/System Design/20. Metrics Monitoring/images/alerting-system.png" alt="alerting-system" width="500" />
</div>
...
<div style="margin-left:3rem">
    <img src="{{site.baseurl}}/assets/images/System Design/20. Metrics Monitoring/images/grafana-dashboard.png" alt="grafana-dashboard" width="500" />
</div>
...
<div style="margin-left:3rem">
    <img src="{{site.baseurl}}/assets/images/System Design/20. Metrics Monitoring/images/final-design.png" alt="final-design" width="500" />
</div>
