...
<div style="margin-left:2rem">
    <img src="{{site.baseurl}}/assets/images/System Design/04. Rate Limiter/images/rate_limiter_architecture.png"  alt="Rate Limiting Middleware Architecture" width="550">
</div>
...
### 1. Token Bucket
<div style="margin-left:2rem">
  <img src="{{site.baseurl}}/assets/images/System Design/04. Rate Limiter/images/token-bucket.png"  alt="Token Bucket Algorithm" width="550">
</div>
...
### 2. Leaking Bucket
<div style="margin-left:2rem">
  <img src="{{site.baseurl}}/assets/images/System Design/04. Rate Limiter/images/leaking-bucket.png"  alt="Leaking Bucket Algorithm" width="550">
</div>
...
<div style="margin-left:2rem">
  <img src="{{site.baseurl}}/assets/images/System Design/04. Rate Limiter/images/fixed-window-counter.png"  alt="Fixed Window Counter" width="550">
</div>
...
could cause more requests than allowed quota to go through.
  ...
  <img src="{{site.baseurl}}/assets/images/System Design/04. Rate Limiter/images/fixed-window-issue.png"  alt="Fixed Window Issue" width="550">


### 4. Sliding Window Log
<div style="margin-left:2rem">
  <img src="{{site.baseurl}}/assets/images/System Design/04. Rate Limiter/images/sliding-window-log.png"  alt="Sliding Window Log" width="550">
</div>
...
<div style="margin-left:2rem">
  <img src="{{site.baseurl}}/assets/images/System Design/04. Rate Limiter/images/sliding-window-counter.png"  alt="Fixed Window Counter" width="550">
</div>
...
<div style="margin-left:2rem">
  <img src="{{site.baseurl}}/assets/images/System Design/04. Rate Limiter/images/architecture.png" style="margin-left: 40px; margin-top: 40px; margin-bottom: 20px;" alt="Architecture" width="550">
</div>
